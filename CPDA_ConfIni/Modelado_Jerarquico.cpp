...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "PREVIO 5 DIEGO CADENA", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Model Dedo2 FUNCIONA
		model = glm::translate(modelTemp, glm::vec3(-0.55f, -0.01f, -0.675f));
		...
		modelTemp = model = glm::translate(model, glm::vec3(-0.3f, -0.9f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		color = glm::vec3(0.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::translate(model, glm::vec3(0.48f, -0.01f, -0.025f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		color = glm::vec3(1.0f, 0.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
